...
export class DataProvider extends Component{
    ...
    render(){
        ...
        const {addCart, increase, decrease, removeProduct, getTotal} = this;
        return(
            <div>
                <DataContext.Provider value={{products, cart, total, addCart, increase, decrease, removeProduct, getTotal}}>
                    {this.props.children}
